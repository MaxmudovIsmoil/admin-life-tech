        ...
        <div class="col-sm-12">
            <div class="card students">
                <div class="btn-group btn-square">
                    <a href="{{ route('student.newcomers') }}"  class="btn btn-square btn-primary">Yangi kelganlar <span class="badge badge-info">{{ $students_count['new'] }}</span></a>
                ...
                <div class="card-body" style="position: relative; padding-top: 10px;">
                    <a href="" class="btn btn-square btn-primary" data-toggle="modal" data-target="#addModal" style="position: absolute; z-index: 1;">Qo'shish</a>

                    {{-- Add Modal--}}
                    @include('student.addModal')

                    <table id="datatableNewStudent" class="display bg-info" style="width:100%;">
                        <thead>
                            <tr>
                                <th width="4%">№</th>
                                <th>Ism</th>
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var tableNewcomers = $('#datatableNewStudent').DataTable({
                paging: true,
                pageLength: 20,
                lengthChange: false,
                searching: true,
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ route("student.getNewcomers") }}',
                columns: [
                    {data: 'number'},
                    {data: 'firstname'},
                    {data: 'lastname'},
            ...
            tableNewcomers.on( 'draw', function () {
