            ...
            <form method="post" action="{{ route('teacher.store') }}" class="js_modal_teacher_form form-group">
                ...
                <div class="modal-body text-left">
                    <div class="row">
                            ...
                            <div class="col-md-4 mt-2">
                                <label for="address">Oldingi lavozimi</label>
                                <input type="text" class="form-control" name="address" id="address">
                                <div class="valid-feedback text-danger address_error">Oldingi lavozimini kiriting!</div>
                            </div>
                            <div class="col-md-4 mt-2">
                                <label for="born">Ish tajribasi</label>
                                <input type="text" class="form-control" name="born" id="born">
                                <div class="valid-feedback text-danger born_error">Ish tajribasini kiriting!</div>
                            </div>
                        </div>
                </div>
