    ...
    public function payment_student(Request $request)
    {
        ...
        if ($validation->fails()) {
            ...
            try {
                ...
                if ($request->payment_id && ($request->qarz > 0) ) {
                    // (qarz to'lash) payment_id bo'lsa payment_detailesni o'ziga qo'shadi
                ...
                else if($request->payment_id && ($request->qarz == '0')) {
                    return response()->json([
                        'success' => false,
                        'warn' => "Qo'uvchi bu oy uchun to'lov qilgan"
                    ]);
                }
                else {
